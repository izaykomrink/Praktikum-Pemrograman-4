...
public class ProdukDao {
    ...
    private String sqlInsert = "insert into produk (kode, nama, harga, terakhirUpdate) " + "values (?,?,?,?)";
    private String sqlUpdate = "update produk set kode=?, nama=?, harga=?, terakhirUpdate=? " + "where id = ?";
    ...
    public List<Produk> cariSemuaProduk() throws Exception {
		...
		private Produk konversiResultSetKeProduk(ResultSet rs) throws SQLException{
            ...
            p.setTerakhirUpdate(rs.getDate("terakhirUpdate"));
            return p;
		}
